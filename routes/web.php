...
Route::get('ajax/login', [AuthController::class,"loginView"]);
Route::get('ajax/register', [AuthController::class,"registerView"]);
Route::post('ajax/do-login', [AuthController::class,"doLogin"]);
Route::post('ajax/do-register', [AuthController::class,"doRegister"]);
Route::get('ajax/logout', [AuthController::class,"logout"]);
// Language Switch
...
Route::group(['namespace' => 'App\Http\Controllers\Frontend', 'as' => 'frontend.'], function () {
    ...
    Route::get('getZipUser', 'uploadZipController@getZipUser');
    Route::get('/uploadZip', 'uploadZipController@uploadZip');
    Route::get('/getAllZip', 'uploadZipController@getAllZip');
    Route::post('/uploadZipFile', 'uploadZipController@uploadZipFile');

    Route::get('/deleteZip/{id}', 'uploadZipController@deleteZip');
...
Route::group(['namespace' => 'App\Http\Controllers\Backend', 'prefix' => 'admin', 'as' => 'backend.', 'middleware' => ['auth', 'can:view_backend']], function () {
    ...
    Route::get('userZip/{id}', 'ZipController@index');
    Route::get('/uploadZip/{id}', 'ZipController@uploadZip');
    Route::post('/uploadZipFile', 'ZipController@uploadZipFile');
    Route::DELETE('/deleteZip/{id}', 'ZipController@deleteZip');
